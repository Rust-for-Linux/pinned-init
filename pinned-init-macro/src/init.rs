...
pub(crate) fn init(
    ...
    Ok(quote! {{
        ...
        let #data = unsafe {
            use ::pinned_init::__internal::#has_data_trait;
        ...
        let init = ::pinned_init::__internal::#data_trait::make_closure::<_, __InitOk, #error>(
            #data,
            move |slot| {
                {
        ...
        let init = unsafe { ::pinned_init::#from_closure::<_, #error>(init) };
        init
    }})
}
